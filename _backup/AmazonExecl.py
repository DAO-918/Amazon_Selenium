...
config = startInit()
'''
链接	ASIN    更新    	国家	变体	品牌	店铺	备注    备注2	标题	AmazonChoice	图片1	图片2	图片3	图片4	图片5	图片6	图片7	图片8	视频	五点1	五点2	五点3	五点4	五点5	五点6 isDeal	现价	RRP	折扣	会员价	coupon	saving	promotion	基本信息	Keepa	卖家精灵	大类排名	小类排名	QA	评分	评价数	分数	特征
...
#file_name =  'ASIN_Info-粘球枪.xlsX'
file_name =  'ASIN_Info-乐高花束2.xlsX'
...
# 设置自动换行的列
columns_to_wrap = ['A', 'E', 'G', 'H','I','J', 'T', 'U', 'V', 'W', 'X','Y', 'AK','AL']
